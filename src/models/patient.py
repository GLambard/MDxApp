...
class PatientData(BaseModel):
    ...
    exam_findings: Optional[str] = Field(default=None, max_length=250, description="Examination findings")
    lab_results: Optional[str] = Field(default=None, max_length=250, description="Laboratory results")
